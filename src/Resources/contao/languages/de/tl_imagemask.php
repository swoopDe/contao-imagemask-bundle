...
$GLOBALS['TL_LANG']['tl_imagemask']['label']         = ['Bild mit Maske', 'Bild mit SVG-Maske'];
$GLOBALS['TL_LANG']['tl_imagemask']['image']         = ['Bild', 'Das sichtbare Bild (wird maskiert).'];
$GLOBALS['TL_LANG']['tl_imagemask']['maskSvg']       = ['Masken-SVG', 'SVG-Datei als CSS-Maske.'];
$GLOBALS['TL_LANG']['tl_imagemask']['bgSize']        = ['Bild-Skalierung', 'background-size'];
